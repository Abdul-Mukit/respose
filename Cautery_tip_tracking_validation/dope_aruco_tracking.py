'''
This code displays a preview of dope-aruco tracking. It doesn't produce any output saved files. This code is used
before the ..._videoMaker.py code to setup the capture scene. Uses intel realsense D435i camera.
'''
import numpy as np
