...
#                     default=None,
#                     help='path to the saved weights folder e.g. training/train_cautery/')
...
weight_list = glob.glob(opt.outf + "/*.pth")
weight_list.sort(key=lambda f: int(filter(str.isdigit, f)))
# print(weight_list)
...
for epoch in range(1, len(weight_list)+1):

    print(weight_list[epoch-1])
    net.load_state_dict(torch.load(weight_list[epoch-1]))
